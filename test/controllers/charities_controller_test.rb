...
class CharitiesControllerTest < ActionController::TestCase
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post :create, charity: { description: @charity.description, name: @charity.name, url: @charity.url, vote: @charity.vote }
    end
  ...
  test "should update charity" do
    patch :update, id: @charity, charity: { description: @charity.description, name: @charity.name, url: @charity.url, vote: @charity.vote }
    assert_redirected_to charity_path(assigns(:charity))
  end
